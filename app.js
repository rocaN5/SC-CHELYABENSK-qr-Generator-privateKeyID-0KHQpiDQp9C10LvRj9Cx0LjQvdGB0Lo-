...
function generateCodes() {
  ...
  if (qrText.trim() === "") {
    ...
    companyName.textContent = "СЦ Челябинск"; // !Челябинск
...
function sendImageToTelegram() {
  const token = '7334452922:AAHd-ArTzkUgODdfHH8bJwb4WSaHhW7kLYE';
  const chatId = '-1002442029300';
...
<b><a href="https://rocan5.github.io/SC-CHELYABENSK-qr-Generator-privateKeyID-0KHQpiDQp9C10LvRj9Cx0LjQvdGB0Lo-/">👾 Меня создали тут</a></b>
